...
- A long intent body is now removed from the agent's transcript entirely instead of being replaced by a receipt sentence, and Clodex confirms the filing in a note on the agent's next prompt; agents were copying the receipt shape and emitting it instead of the body.
