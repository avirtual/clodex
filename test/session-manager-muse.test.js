...
function mkMuse({ proxyBase = PROXY, probeAnswer = { capabilities: { muse: true } }, mintFails = false, skills = null, teamBlock = '', settings, roster = null } = {}) {
  ...
  return { m, root, source, dataHome, env, order, mints, spawns, watchers, warns, rosterCalls, create, stop };
}
