...
// A snapshot as the core really emits one. Only the four fields the subscriber's
...
function snap({ pending = null, mode = 'tap', target = 'a', anyClaudeRow = true } = {}) {
  return { pending, mode, target, anyClaudeRow };
}
