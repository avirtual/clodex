...
const CONFINED = [
  ...
  ['skill-delivery.js', 'writeSkillTree', 'SKILL_PLUGINS_DIR'],
...
test('the write/cleanup call sites fail DIFFERENTLY, and deliberately so', () => {
  ...
  for (const [file, fn] of [['skill-delivery.js', 'deliverClaude'], ['skill-delivery.js', 'writeSkillTree'], ['engine.js', 'writeAgentPlugin']]) {
