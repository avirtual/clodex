...
test('t1059: a spill row is an ordinary clodex → agent row, and the export line carries the filed path verbatim', () => {
  const row = { type: 'spill', from: 'clodex', to: 'wirescope', body: 'task add hand (1234 B) filed at /x/y.md', path: '/x/y.md' };
  ...
  assert.strictEqual(line, '2026-07-15T12:34:56.789Z clodex -> wirescope task add hand (1234 B) filed at /x/y.md');
});
