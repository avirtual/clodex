...
const API_CONTRACT = [
  ...
  { name: 'teamStockRoles', kind: 'invoke', channel: 'team:stockRoles' },
  ...
  // session-less by nature — each figure is a whole account's, and it arrives on
  // a forwarded turn rather than on a poll.
  ...
  { name: 'moveSessionToPeer', kind: 'invoke', channel: 'session:move-to-peer' },
  { name: 'onSessionMoveProgress', kind: 'on', channel: 'session:move-progress' },
  { name: 'moveSessionToWorkspace', kind: 'invoke', channel: 'session:move-to-workspace' },
