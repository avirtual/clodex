...
**every skill off**, the trimmed tools list, and those three
...
Grep, Bash, Agent, SendMessage — and deny the rest of the catalog;
...
5. Start the lead seat and open a ticket. `[agent:spawn name:<name>-lead
   ...
   `clodex-team-lead` (the box's default model, every skill off, the team, monitor and run-tests
